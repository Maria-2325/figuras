...
public class Figuras {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("El radio es: " + objCirculo.radio + " cm" );
        ...
        System.out.println("Datos: ");
        System.out.println("El lado es: " + objCuadrado.lado + " cm" );
        ...
        System.out.println("Datos: ");
        System.out.println("La base es: " + objRectangulo.base + " cm" );
        System.out.println("La altura es: " + objRectangulo.altura + " cm" );
        ...
        System.out.println("Datos: ");
        System.out.println("La base es: " + objTrianguloRectangulo.base + " cm" );
        System.out.println("La altura es: " + objTrianguloRectangulo.altura + " cm" );
